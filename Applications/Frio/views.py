                ...
                with connections['TRESASES_APLICATIVO'].cursor() as cursor:
                    sql = """ 
                            ...
                            SELECT        HorasExtras_Procesadas.ID_HEP AS ID, HorasExtras_Procesadas.Legajo AS LEGAJO, CONVERT(VARCHAR(25),TresAses_ISISPayroll.dbo.Empleados.ApellidoEmple + ' ' + TresAses_ISISPayroll.dbo.Empleados.NombresEmple) AS NOMBRE, 
                                            ...
                                            (CONVERT(VARCHAR(10), HorasExtras_Procesadas.FechaHoraDesde, 103) + '-' + CONVERT(VARCHAR(5), HorasExtras_Procesadas.FechaHoraDesde, 108)) AS DESDE, (CONVERT(VARCHAR(10), HorasExtras_Procesadas.FechaHoraHasta, 103) + '-' + CONVERT(VARCHAR(5), HorasExtras_Procesadas.FechaHoraHasta, 108)) AS HASTA, 
