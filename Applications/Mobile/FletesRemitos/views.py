                ...
                if verificaBinLleno(IdAsignacion) == 'RAU':
                    try:
                        if verificaLote(IdAsignacion):
                            ...
                            insertar_registro_error_sql("ELSE BIN NO INGRESO","actualizaEstadoPosicion","Aplicacion","error")
                        ...
                        mensaje_error = str(e)
                        insertar_registro_error_sql("ELSE BIN NO INGRESO","actualizaEstadoPosicion","Aplicacion",mensaje_error)
                        return JsonResponse({'Message': 'Error', 'Nota': mensaje_error})                    
