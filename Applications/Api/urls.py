...
urlpatterns = [
    ...
    path('fruit/descarga-remito/remito=<str:ID_REMITO>/', fruit.crear_remito_ID, name="crear_remito_ID"),

    path('fruit/descarga-remito/nombre=<str:nombreRemito>/', fruit.descargar_pdf, name="descargar_pdf"),
